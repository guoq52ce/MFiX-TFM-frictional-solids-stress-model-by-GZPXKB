...
!********************************************qg***********************************************
   ...
   USE solids_pressure, only: Neg_H
!********************************************qg*********************************************** 
...
!********************************************qg***********************************************
        ReactionRates(:,1)=P_s(:,1)
        ReactionRates(:,2)=Mu_s(:,1)
        ReactionRates(:,3)=LAMBDA_s(:,1)
        ReactionRates(:,4)=EPMU_S(:,1)
        ReactionRates(:,5)=2.d0*Mu_s(:,1)*SQRT(2d0*(trD_s2(:,1) - ((trD_s_C(:,1)*trD_s_C(:,1))/3.d0)))
!********************************************qg***********************************************	  
